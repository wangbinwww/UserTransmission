...
function MessageAnalysis(RecvData, LoopNum) {
  ...
  if (C1Code[0] == [0x1c]) {
    ...
    var CDataTime = "20" + RecvData[34].toString(10) + "年" + RecvData[33].toString(10) + "月" + RecvData[32].toString(10) + "日" + RecvData[31].toString(10) + "时" + RecvData[30].toString(10) + "分" + RecvData[29].toString(10) + "秒"
